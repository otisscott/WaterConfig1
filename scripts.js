...
function AppendThings() {
    ...
    $(pumpCollection).each(function() {
        $('#pumpsel').append($("<option>" + this.name + "</option>"))
    });
    $('#pumpsel').change(function() {
        myPump = "";
        $(pumpCollection).each(function(){
            if(this.name == $('#pumpsel :selected').text()) {
                myPump += this;
            }
        });
    });
    ...
    $(radCollection).each(function() {
        $('#radsel').append($("<option>" + this.name + "</option>"))
    });
    $('#radsel').change(function() {
        myRads = [];
        $(radCollection).each(function(){
            if(this.name == $('#radsel :selected').text()) {
                myRads += this;
            }
        });
    });
    $(fanCollection).each(function() {
        $('#fansel').append($("<option>" + this.name + "</option>"))
    });
    $('#fansel').change(function() {
        myFans = [];
        $(fanCollection).each(function(){
            if(this.name == $('#fansel :selected').text()) {
                myFans = this;
            }
        });
    });
